...
- Public Landing Page Components (`src/features/landing/components/`):
  ...
  - `ScoutValuesSection.tsx`: Institutional scout identity cards representing *Promesa y Ley Scout*, *Reconocimiento al Mérito*, *Hermandad Scout*, and *Siempre Listos*.
